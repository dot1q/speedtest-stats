...
$sql = "SELECT CLIENT_BROWSER FROM tbl_data";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
		$data[$row["CLIENT_BROWSER"]] = (int)$data[$row["CLIENT_BROWSER"]]+1;
    }
} else {
    echo "0 results";
}
...
$b1plot->SetFillColor("#aa01b5");

$graph->title->Set("Top ".$max_data_points." Browsers Performing Speedtests (Overall)");
